...
SUDO = SUDO
sudo_users = {SUDO,1971729671,2091654958,1244079708,2136984893}   
print([[
> CH › @ERR5R3
> CH › @ERR5R3
~> DEVELOPER › @Y_is_f
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MARKTEAM/Files_MARK/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1971729671) then  
var = true   
elseif tonumber(user_id) == tonumber(2091654958) then
var = true
elseif tonumber(user_id) == tonumber(1244079708) then
var = true
elseif tonumber(user_id) == tonumber(2136984893) then
var = true
...
local UserName = (data.username_ or "ERR5R3")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@Y_is_f")  
...
--------------------------------------------------------------------------------------------------------------
function SourceMARK(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."MARK1:List:Filter"..sl)
...
os.execute('wget https://raw.githubusercontent.com/S4ZI82/S79KLO/main/MARK.lua')
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❖︙[تحديثات البوت](t.me/ERR5R3) \n❖︙[قناه السورس](t.me/ERR5R3)')
end
...
if text == 'الجروبات ❖' and DevMARKW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❖︙الجروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == "تنظيف الجروبات ❖" and DevMARKW(msg) then 
...
send(msg.chat_id_, msg.id_,'*❖︙عدد الجروبات الان » { '..#group..' }'..MARKk..''..MARK..'*\n*❖︙الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات*\n')   
end
end
end,nil)
end
...
usertext = '*\n ❖︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'ERR5R3')..')'
status  = '\n *❖︙تم ترقيته مطور*'
...
usertext = '\n *❖︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'ERR5R3')..')'
status  = '\n*❖︙تم ترقيته مطور*'
...
if MARK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❖︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ERR5R3')..') \n ❖︙'..MARK1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *❖︙العضو :* {["..data.first_name_.."](T.ME/ERR5R3)}\n❖︙["..MARK_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *❖︙عذرا ↫* {["..data.first_name_.."](T.ME/ERR5R3)}\n*❖︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'تحديث السورس' and DevMARKW(msg) then 
os.execute('rm -rf MARK.lua')
os.execute('wget https://raw.githubusercontent.com/MARKTEAM/MARK/main/MARK.lua')
send(msg.chat_id_, msg.id_,' *❖︙تم تحديث السورس* \n*❖︙لديك اخر اصدار لسورس روليكس*\n*❖︙الاصدار » { 2.8v}*')
dofile('MARK.lua')  
end
...
if t2.id_ then 
name_MARK = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MARK then 
names_MARK = database:smembers(bot_id.."MARK:blocname"..msg.chat_id_) or ""
if names_MARK and names_MARK[1] then 
for i=1,#names_MARK do 
if name_MARK:match("(.*)("..names_MARK[i]..")(.*)") then 
...
function amir_MARKa_new(MARK1,MARK2)
if MARK2 and MARK2.first_name_ then 
if MARK2.first_name_:match("(.*)"..database:get(bot_id.."MARK:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MARK:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local MARK_nnn = database:get(bot_id.."MARK:nump"..msg.chat_id_) or 5
local MARK_nnn2 = database:get(bot_id.."MARK:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(MARK_nnn2) == tonumber(MARK_nnn) or tonumber(MARK_nnn2) > tonumber(MARK_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MARK:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❖︙عزيزي >>["..MARK2.username_.."](https://t.me/"..(MARK2.username_ or "ERR5R3")..")\n❖︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MARK:teh"..msg.chat_id_).."} بجانب اسمك\n❖︙عدد المحاولات المتبقيه {"..(tonumber(MARK_nnn) - tonumber(MARK_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_MARKa_new)
end
end
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝙰𝚁𝙺\n\n[❖  𝙼𝙰𝚁𝙺 ᴄʜᴀɴɴᴇʟ](http://t.me/ERR5R3)\n\n[❖  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/ERR5R3)\n\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❖ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝙰𝚁𝙺',url="t.me/ERR5R3/906"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ERR5R3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '*❖︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ERR5R3')..') \n*❖︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❖︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ERR5R3')..') \n*❖︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
function start_function(extra, result, success)
if MARKSudoBot(result.sender_user_id_) then
...
if MARKSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*❖︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if DevMARKW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MARKTEAM/Files_MARK/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *❖︙اهلا بك في متجر ملفات روليكس*\n*❖︙ملفات السورس ↓*\n*•━━━━━━ ꪑꪖ𝘳𝘬 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ ꪑꪖ𝘳𝘬 ━━━━━━━•*\n *❖︙علامة تعني { ✓ } ملف مفعل*\n *❖︙علامة تعني { ✘ } ملف معطل*\n *❖︙قناة سورس روليكس ↓*\n".." *❖︙*[اضغط هنا لدخول](t.me/ERR5R3) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MARKTEAM/Files_MARK/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *❖︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'ERR5R3')..')'
status  = '\n*❖︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *❖︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'ERR5R3')..')'
status  = '\n*❖︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *❖︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *❖︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'ERR5R3')..')'
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❖ 𝘴ꪮꪊ𝘳ᥴꫀ ꪑꪖ𝘳𝘬 .',url="t.me/ERR5R3"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *❖︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'ERR5R3')..')'..'\n*❖︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,MARK)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ ꪑꪖ𝘳𝘬 ━━━━━━━•*\n"
x = 0
...
if MARKSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ERR5R3')..')'
local iduser = result.sender_user_id_
...
{{text = '𝘴ꪮꪊ𝘳ᥴꫀ ꪑꪖ𝘳𝘬.', url="t.me/ERR5R3"}},
{{text = 'مطور السورس', url="t.me/Y_is_f"}},
}
...
send(msg.chat_id_, msg.id_, t..'ٴ❖∫ٴ*•━━━━━━ ꪑꪖ𝘳𝘬 ━━━━━━━•*ٴ❖∫○ٴ\n❖︙[𝘴ꪮꪊ𝘳ᥴꫀ ꪑꪖ𝘳𝘬.](t.me/ERR5R3) ')
end
...
inline = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝙰𝚁𝙺',url='http://t.me/ERR5R3'}},
}
